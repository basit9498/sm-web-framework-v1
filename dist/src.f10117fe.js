...
exports.Axios = Axios;
},{"./lib/axios.js":"node_modules/axios/lib/axios.js"}],"src/model/Collection.ts":[function(require,module,exports) {
"use strict";
...
},{"./Eventing":"src/model/Eventing.ts","axios":"node_modules/axios/index.js"}],"src/model/Attibute.ts":[function(require,module,exports) {
"use strict";
...
exports.User = void 0;
var Attibute_1 = require("./Attibute");
...
var User = /*#__PURE__*/function (_Model_1$Model) {
  ...
  _createClass(User, [{
    ...
    value: function buildUser(attrs) {
      return new User(new Attibute_1.Attribute(attrs), new Eventing_1.Eventing(), new Sync_1.Sync(rootUrl));
    }
  }, {
...
exports.User = User;
},{"./Attibute":"src/model/Attibute.ts","./Collection":"src/model/Collection.ts","./Eventing":"src/model/Eventing.ts","./Model":"src/model/Model.ts","./Sync":"src/model/Sync.ts"}],"src/views/CollectionView.ts":[function(require,module,exports) {
"use strict";
...
var CollectionView = /*#__PURE__*/function () {
  ...
  _createClass(CollectionView, [{
    ...
    value: function render() {
      ...
      var _iterator = _createForOfIteratorHelper(this.collection.model),
        _step;
      try {
    ...
    value: function bindEvents(fragment) {
      ...
      var _loop = function _loop(eventKey) {
        var _eventKey$split = eventKey.split(":"),
          ...
          selector = _eventKey$split2[1]; //click:button
...
// user.trigger("click");
// console.log(user);
},{"./model/Collection":"src/model/Collection.ts","./model/User":"src/model/User.ts","./views/UserList":"src/views/UserList.ts"}],"../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
